#runnig_______________________________MobileNetV2_____________________________________running#
import cv2
import numpy as np
import os
...
model.save_weights('/kaggle/working/MobileWeights.h5')        
# Evaluate the model
...
data = []
path = "/kaggle/input/data-set/data_set/test/0004/01_0004_(10_03_21_21_22_20)_c"
...
model1 = load_model('/kaggle/working/MobileNetV2.h5')
